...
public class FabricaConexoes 
{
	...
	public static void getConexao()
	{
        ...
        public static void getConexaoMy()
        {
            try
		{
			Class.forName("com.mysql.jdbc.Driver");
			con = DriverManager.getConnection("jdbc:mysql://localhost/producao", "root", "12345");
		}
		catch (Exception e)
		{
			JOptionPane.showMessageDialog(null, "Falha ao tentar conectar com banco de dados.\n"+e.getMessage());
        ...
        public static PreparedStatement returnStatement(String sql)
        {
            ...
            try{
                stm = con.prepareStatement(sql,ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
                 return stm;
