...
import controler.sistema.GrupoControler;
...
public class GrupoView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pnlgrupo.setBorder(javax.swing.BorderFactory.createTitledBorder("Grupo"));
        ...
        pnlgrupos_cadastrados.setBorder(javax.swing.BorderFactory.createTitledBorder("Grupos cadastrados"));
    ...
    private void jbtexcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtexcluirActionPerformed
        montaGrupo();
        controler.excluirGrupo(grupo);
        limpaCampos();
        grupodata.atualizaDados();
        jtbgrupos.revalidate();
        jtbgrupos.repaint();
    ...
    private void jtfpesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfpesquisarKeyReleased
        ...
        sorter = new TableRowSorter<TableModel>(jtbgrupos.getModel());
        jtbgrupos.setRowSorter(sorter);
    ...
    private void montaGrupo()
    {
        ...
        try
        {
            grupo.setId(Integer.parseInt(jtfid_grupo.getText()));
        }
        ...
        grupo.setDescricao(jtfdescricao.getText());
    }
    ...
    private ListSelectionListener selectionListener = new ListSelectionListener()
    {
        public void valueChanged(ListSelectionEvent e)
        {
            ...
            jtfdescricao.setText(grupo.getDescricao());
            jtfid_grupo.setText(String.valueOf(grupo.getId()));
